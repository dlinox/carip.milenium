            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="form-salles-products" method="POST" class="form form-vertical"
                            action="{{ route('admin.export_sales_product') }}" target="_blank">
                            @csrf
                            <div class="row">
                                <div class="mt-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive-sm mt-3">
                                    <table class="table table-sm mb-0 fs--1">
                                        <thead>
                                            <tr>
                                                <th class="text-center" width="10%">C&oacute;digo</th>
...
@endsection
@section('scripts')
    @include('admin.reports.sales.products.js-home')
@endsection
