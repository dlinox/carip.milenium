...
var div = document.getElementById('ID-load'),
  content__wrapper = document.getElementById('layout-content');

// remover loading despues de la carga
if (div) 
{
  content__wrapper.style.display = 'block';
  div.remove();
